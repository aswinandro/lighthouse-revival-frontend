...
export function CoursesManagement() {
  ...
  if (loading && courses.length === 0 && memberCourses.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] space-y-4">
        <Loader size={80} />
        <p className="text-sm text-muted-foreground animate-pulse">Gathering wisdom...</p>
      </div>
    )
  }
        ...
        <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
          ...
          <DialogContent>
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button onClick={handleCreateCourse} disabled={loading}>{loading ? "Creating..." : "Create Course"}</Button>
            </div>
          </DialogContent>
        </Dialog>
      </div>
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="flex items-center justify-between pt-2">
                      <div className="text-sm">
                        ...
                        <span className="ml-1 font-medium">{course.startDate ? new Date(course.startDate).toLocaleDateString() : 'N/A'}</span>
                      </div>
